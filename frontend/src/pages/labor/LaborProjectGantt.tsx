    ...
    for (const a of rows) {
      if (!map.has(a.project_id)) {
        ...
        map.set(a.project_id, {
          ...
          project_start: a.project_start_date ? startOfDay(new Date(a.project_start_date)) : null,
          project_end: a.project_end_date ? startOfDay(new Date(a.project_end_date)) : null,
          labor_start: null,
          labor_end: null,
          crew_count: 0,
          assignments: [],
