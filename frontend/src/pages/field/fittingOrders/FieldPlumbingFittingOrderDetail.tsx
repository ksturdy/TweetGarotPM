...
const FieldPlumbingFittingOrderDetail: React.FC = () => {
  ...
  const submitMutation = useMutation({
    mutationFn: () => plumbingFittingOrdersApi.submit(Number(id)),
    onSuccess: () => {
  ...
  return (
    <div>
      ...
      <div className="field-detail-section">
        ...
        <div className="field-detail-row">
          <span className="field-detail-label">Fixture Type</span>
          <span className="field-detail-value">{order.fixture_type || '-'}</span>
        </div>
        <div className="field-detail-row">
          <span className="field-detail-label">Rough-In Dimensions</span>
          <span className="field-detail-value">{order.rough_in_dimensions || '-'}</span>
        </div>
      </div>
